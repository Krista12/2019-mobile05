    ...
    public void handlerClickLoadRedFragment(View view) {
       ...
       // fragmentTransaction.commit();
        ...
        if(fragment == null || fragment instanceof BlueFragment){
            getSupportFragmentManager().beginTransaction().replace(R.id.dynamic_fragment_placeholder, new RedFragment(), "RED_FRAGMENT")
                    .addToBackStack(null)
                    .commit();
        }
    }
    public void handlerClickBlueFragment(View view) {
       // FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
       // fragmentTransaction.setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
       // fragmentTransaction.setCustomAnimations(R.anim.enter_from_left,R.anim.exit_from_left,R.anim.enter_from_left,R.anim.exit_from_right);
       ...
       // fragmentTransaction.commit();
        ...
        if (fragment == null || fragment instanceof RedFragment){
            getSupportFragmentManager().beginTransaction().replace(R.id.dynamic_fragment_placeholder, new BlueFragment(), "BLUE_FRAGMENT")
                    .addToBackStack(null)
                    .commit();
        }
    }
